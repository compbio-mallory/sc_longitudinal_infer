...
# a and b are two arrays, each entry denoting the cluster ID the cell belongs to. The Rand Index computes a similarity measure between two clusterings. 
def ARI(a, b):
...
for i in inputs:
    ...
    if if_v_measure:
        ...
        ari = ARI(clu_IDs, gt_IDs)
        print("Adjusted Rand index for "+ method + ": "+str(ari))
