...
from usage import bnpc_assignment, scg_assignment, scclone_assignment, robustclone_assignment, scite_assignment, siclonefit_assignment, lace_assignment
...
for i in inputs:
    ...
    if method == "sccluster":
        ...
        clu_IDs = lace_assignment(result_file)
        num_cells = len(clu_IDs)
