...
def findSNVpairs_OnAncestralBranches(pID_cID, node_mut, sameSNV_pairs):
    SNV_pairs = []
...
SNV_pairs_OnAncestralBranch = findSNVpairs_OnAncestralBranches(pID_cID, node_mut_forAncestral, SNV_pairs_onSameBranch)
